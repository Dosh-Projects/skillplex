const courses = [
  ...
  },
  {
    ...
    rating: 4.5,
    reviews: 44,
    image: "../assets/img/course/course-9.jpg",
  ...
  // ...
  {
    ...
    rating: 4.5,
    reviews: 44,
    image: "../assets/img/course/course-7.jpg",
  ...
  },
  {
    ...
    rating: 4.5,
    reviews: 44,
    image: "../assets/img/course/course-8.jpg",
    ...
    .map(
      ...
      <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-6">
                  ...
                  <div class="course__meta d-flex align-items-center justify-content-between">
                      <div class="course__lesson">
                          <span><i class="far fa-book-alt"></i>${
                            course.lessons
                          } Lesson${course.lessons > 1 ? "s" : ""}</span>
                      </div>
        ...
        course.reviews
                  ...
                  <h3 class="course__title"><a href="${course.link}">${
        course.title
      }</a></h3>
              </div>
